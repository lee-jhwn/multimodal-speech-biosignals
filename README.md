...
Official repository for our Interspeech 2026 paper.
...
Access is gated. You'll be asked to accept the data license before downloading, because
the recordings are from a single speaker and include their voice and real-time MRI of the
vocal tract.

It covers 18 VCV syllables produced three ways — spoken, silently articulated, and
imagined — recorded both inside the MRI scanner (with simultaneous rtMRI, EEG and audio)
